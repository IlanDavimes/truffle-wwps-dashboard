...
const seedConsultants: Consultant[] = [
  ...
  {
    id: 'alix-trublet-de-nermont',
    status: 'active',
    firstName: 'Alix',
    surname: 'Trublet De Nermont',
    suggestedRole: 'Senior Project Planner — Nuclear & Infrastructure',
    currentRole: 'Project Planner / Scheduler (Lead)',
    summary:
      "Detail-oriented and results-driven Project Planner and Scheduler with extensive experience leading project controls, scheduling, and stakeholder coordination within the nuclear and industrial sectors. Proven ability to develop, monitor, and optimize project timelines using Primavera P6 and Microsoft Project, ensuring on-time delivery and compliance with NEC3 contractual frameworks. Recognised for driving collaboration across multidisciplinary teams and maintaining precision in reporting and forecasting.",
    avatar: '/avatars/Alix Trublet De Nermont.jpg',
    videoUrl: '',
    videoEnabled: false,
    contact: {
      location: 'Cape Town, South Africa',
      email: '',
      phone: '+27 60 966 7647',
      linkedin: 'linkedin.com/in/alixtrublet',
      permitNumber: 'RSA Citizen',
    },
    badges: [
      { label: 'Primavera P6 Oracle Certified', style: 'premium' },
      { label: 'Nuclear Sector', style: 'accent' },
      { label: 'NEC3 Contracts', style: 'accent' },
      { label: 'Project Controls', style: 'default' },
      { label: 'Scheduling & Planning', style: 'default' },
    ],
    availability: {
      status: 'Available now',
      details: 'Based in Cape Town, South Africa; currently employed and open to new opportunities',
    },
    readiness: [
      'Oracle Certified Primavera P6 Specialist',
      'NEC3 Contract knowledge',
      'Lead Project Planner — Nuclear (KNPS)',
    ...
    skills: [
      { category: 'Planning tools', items: ['Primavera P6 (Oracle Certified)', 'Microsoft Project', 'MSP scheduling', 'MS Suite'] },
      { category: 'Contracts & frameworks', items: ['NEC3', 'Compensation Events', 'Early Warnings', 'Terms Service Contracts'] },
      { category: 'Project controls', items: ['S-Curves', 'Look-Aheads', 'Planned vs Actual reporting', 'Delay analysis', 'Risk register development'] },
      { category: 'Leadership', items: ['Stakeholder engagement', 'Multidisciplinary coordination', 'Daily planning leadership', 'Team training'] },
    ],
    experience: [
      {
        title: 'Project Planner / Scheduler (Lead)',
        company: 'Necsa',
        location: 'Cape Town, South Africa',
        ...
        isCurrent: true,
        bullets: [
          'Developed and implemented baseline schedules for all Koeberg Nuclear Power Station (KNPS) projects.',
          'Created and maintained tracking sheets to ensure daily project updates were delivered to the client.',
          'Produced S-Curves, Look-Aheads and Percentage Planned vs Actual reports.',
          'Coordinated KNPS project tasks and led daily planning activities on site.',
          'Coordinated stakeholder engagement across project teams, clients and vendors.',
          'Supported all projects in Early Warnings and Compensation Events per NEC3 and Terms Service Contracts.',
        ],
        achievement: 'Led scheduling and project controls for multiple simultaneous KNPS nuclear projects, ensuring on-time delivery and full NEC3 contractual compliance.',
      },
      {
        title: 'Primavera Specialist and Trainer',
        company: 'Synergy Projects Consulting',
        location: 'Johannesburg, South Africa',
        period: 'Mar 2018 – Nov 2021',
        duration: '3 years 8 months',
        isCurrent: false,
        bullets: [
          'Served as a Certified Oracle Primavera P6 Specialist, providing expert guidance and training to project teams and clients.',
          'Delivered consulting services to clients including Engen, ALNG, and Sapref, resulting in improved project planning and execution.',
        ],
        achievement: 'Delivered Primavera P6 consulting and training to major industrial clients including Engen and Sapref, directly improving project planning capability across organisations.',
      },
    ],
    education: [
      { degree: 'Oracle Certified Primavera P6 Specialist', institution: 'Oracle', year: '', highlight: 'Certified specialist in Primavera P6 project scheduling software' },
    ],
    references: [
      { name: 'Available on request', role: 'Project Director', company: 'Necsa', contact: 'Provided upon shortlisting' },
    ],
  },
  {
